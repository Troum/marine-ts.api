...
final class SiteSeoPageRepository implements SiteSeoPageRepositoryInterface
{
    /**
    ...
    {
        DB::transaction(function () use ($page, $translationsByLocale): void {
            foreach ($translationsByLocale as $locale => $row) {
