...
final class FeedbackMessageRepository extends BaseRepository implements FeedbackMessageRepositoryInterface
{
    public function __construct(FeedbackMessage $model)
    {
