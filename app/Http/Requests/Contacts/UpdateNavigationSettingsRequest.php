...
class UpdateNavigationSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'burgerContacts.phonesTitle' => ['nullable'],
            'burgerContacts.phonesTitle.ru' => ['nullable', 'string', 'max:8000'],
            'burgerContacts.phonesTitle.en' => ['nullable', 'string', 'max:8000'],
            'burgerContacts.phones' => ['nullable', 'array', 'max:10'],
            'burgerContacts.phones.*' => ['string', 'max:40'],
            'burgerContacts.emailTitle' => ['nullable'],
            'burgerContacts.emailTitle.ru' => ['nullable', 'string', 'max:8000'],
            'burgerContacts.emailTitle.en' => ['nullable', 'string', 'max:8000'],
            ...
            'burgerContacts.officesColumnTitle' => ['nullable'],
            'burgerContacts.officesColumnTitle.ru' => ['nullable', 'string', 'max:8000'],
            'burgerContacts.officesColumnTitle.en' => ['nullable', 'string', 'max:8000'],
            'burgerContacts.offices' => ['nullable', 'array', 'max:10'],
            'burgerContacts.offices.*.title' => ['nullable'],
            'burgerContacts.offices.*.title.ru' => ['nullable', 'string', 'max:120'],
            'burgerContacts.offices.*.title.en' => ['nullable', 'string', 'max:120'],
            'burgerContacts.offices.*.address' => ['required'],
            'burgerContacts.offices.*.address.ru' => ['nullable', 'string', 'max:2000'],
            'burgerContacts.offices.*.address.en' => ['nullable', 'string', 'max:2000'],
