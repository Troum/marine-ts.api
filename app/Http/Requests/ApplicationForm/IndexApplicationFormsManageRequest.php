...
class IndexApplicationFormsManageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'sort' => ['sometimes', 'string', Rule::in([
                'id', 'created_at', 'updated_at', 'full_name', 'email', 'status', 'vacancy_id',
            ])],
    ...
    public function toPaginatedTableDto(): PaginatedTableRequestDto
    {
        ...
        return new PaginatedTableRequestDto(
            perPage: min(max((int) ($v['per_page'] ?? 50), 1), 500),
