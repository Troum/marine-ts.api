...
class SiteSeoPagesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pages = [
            ...
            ['slug' => 'ship-repair', 'label' => 'Судоремонт', 'seo_title' => 'Судоремонт — Marine Technical Solutions', 'seo_description' => 'Ремонт корпуса, главных и вспомогательных машин, электроавтоматика, докование.', 'seo_keywords' => 'судоремонт, ремонт судов, ship repair'],
            ['slug' => 'spare-parts', 'label' => 'Запчасти', 'seo_title' => 'Запчасти и снабжение — Marine Technical Solutions', 'seo_description' => 'Поставка запчастей в порт захода, логистика и единое окно заявок.', 'seo_keywords' => 'запчасти для судов, ship spares, снабжение'],
