...
class SiteSeoPagesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pages = [
            ...
            ['slug' => 'engineering', 'label' => 'Инжиниринговые услуги', 'seo_title' => 'Инжиниринговые услуги — Marine Technical Solutions', 'seo_description' => '3D-сканирование, моделирование, расчёты МКЭ, надзор и подготовка технической документации для морского флота.', 'seo_keywords' => 'инжиниринг, 3D сканирование, 3D моделирование, МКЭ, морской инжиниринг'],
            ['slug' => 'spare-parts-supply-and-procurement-services', 'label' => 'Судовое снабжение и услуги по закупкам', 'seo_title' => 'Судовое снабжение и закупки — Marine Technical Solutions', 'seo_description' => 'Поставки запасных частей, оборудования и материалов для палубных и машинных отделений морских судов.', 'seo_keywords' => 'судовое снабжение, ЗИП, закупки, судовые запчасти, оборудование для флота'],
