...
class SiteSeoPagesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pages = [
            ...
            ['slug' => 'services', 'label' => 'Сервисы', 'seo_title' => 'Сервисы — судоремонт и техобслуживание', 'seo_description' => 'Ремонт корпусов, двигателей, электрики и инжиниринг для судов.', 'seo_keywords' => 'сервисы, ремонт судов'],
